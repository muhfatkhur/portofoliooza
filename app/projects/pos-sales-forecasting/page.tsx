...
const project = {
  ...
  title: "Sistem Point of Sale & Inventaris Warung dengan Prediksi Holt’s Linear",
  shortTitle: "POS & Holt’s Linear Forecasting",
  category: "Point of Sale & Business Intelligence",
  role: "Full-Stack Developer",
  platform: "Web Application",
  focus: "POS, Inventory & Revenue Forecasting",
  description:
    "Aplikasi web terpusat untuk mengelola transaksi penjualan harian, inventaris barang, analisis keuangan warung, serta prediksi tren omset menggunakan algoritma Holt’s Linear.",
  technologies: ["Laravel", "PHP", "MySQL", "Tailwind CSS", "JavaScript", "HTML5", "ApexCharts.js", "Holt’s Linear"],
  screenshots: [
    {
      src: "/images/projects/kasir/dashboard.png",
      alt: "Dashboard POS dan prediksi omset",
      caption: "Dashboard ringkasan transaksi dan grafik prediksi omset menggunakan Holt’s Linear.",
    },
    {
      src: "/images/projects/kasir/stok.png",
      alt: "Manajemen produk dan inventaris",
      caption: "Pengelolaan produk, kategori, harga, stok, dan peringatan persediaan menipis.",
    },
    {
      src: "/images/projects/kasir/laporan.png",
      alt: "Laporan keuangan dan nilai inventaris",
      caption: "Rekap pendapatan, keuntungan bersih, riwayat transaksi, dan nilai aset stok.",
    },
    {
      src: "/images/projects/kasir/kasir.png",
      alt: "Halaman transaksi kasir POS",
      caption: "Alur kasir untuk menghitung total belanja, pembayaran, dan kembalian.",
    },
  ] as Screenshot[],
...
const workflow = [
  {
    ...
    description: "Sistem membaca transaksi historis, menghitung omset, lalu memproses data melalui algoritma Holt’s Linear untuk menampilkan grafik prediksi.",
  },
  {
    title: "Manajemen Data",
    description: "Pengguna mengelola kategori dan mencatat produk beserta harga, stok awal, serta informasi inventaris lainnya.",
  },
  {
    title: "Transaksi Kasir (POS)",
    description: "Kasir memproses pembelian, menghitung total dan kembalian, kemudian sistem otomatis mengurangi stok gudang.",
  },
  {
    title: "Buku Laporan Keuangan",
    description: "Sistem menyediakan rekap pendapatan, keuntungan bersih, riwayat transaksi, dan nilai aset stok secara terpusat.",
  },
];

const features: Feature[] = [
  {
    title: "Modul POS & Transaksi",
    description: "Pencatatan kasir cepat lengkap dengan rincian bon belanja, total pembayaran, dan kembalian.",
    icon: MapPin,
  },
  {
    title: "Manajemen Inventaris",
    description: "Pemantauan stok secara real-time dengan peringatan otomatis untuk barang yang mulai menipis.",
    icon: Camera,
  },
  {
    title: "Peramalan Tren Holt’s Linear",
    description: "Prediksi estimasi pendapatan berdasarkan pola dan tren data transaksi sebelumnya.",
    icon: MessageCircle,
  },
  {
    title: "Optimasi Performa",
    description: "Penggunaan Eager Loading untuk menjaga efisiensi kueri database saat data transaksi bertambah.",
    icon: RefreshCw,
  },
];
...
export default function WorkshopRecommendationPage() {
  ...
  return (
    <>
      ...
      <meta
        name="description"
        content="Case study sistem Point of Sale, inventaris warung, dan prediksi omset menggunakan Holt’s Linear."
      />
                ...
                <div className="grid gap-8 lg:grid-cols-[minmax(0,0.28fr)_minmax(0,1fr)] lg:gap-10">
                  <div className="lg:pt-2">
                    ...
                    <p className="mt-4 max-w-xs text-sm leading-6 text-[var(--muted)]">
                      Pilih gambar untuk melihat detail tampilan sistem.
                    </p>
                  </div>
                  <ScreenshotCarousel
                ...
                <div className="grid gap-10 lg:grid-cols-[minmax(0,1.25fr)_minmax(18rem,0.75fr)] lg:gap-16">
                  <div className="max-w-3xl space-y-6 text-lg leading-8 tracking-[-0.01em] sm:text-xl sm:leading-9">
                    ...
                    <p className="text-[var(--muted)]">
                      Sistem terpusat untuk mengelola penjualan harian,
                      persediaan barang, laporan keuangan, dan analisis tren
                      omset. Backend Laravel mengamankan logika bisnis serta
                      database, sementara Holt’s Linear memproses histori
                      transaksi menjadi prediksi pendapatan.
                    </p>
                  </div>
                  ...
                  <dl className="border-t border-[var(--line)]">
                    {[
                      ...
                      ["PRIMARY USER", "Kasir, pemilik & admin warung"],
                      ["FORECAST ENGINE", "Holt’s Linear"],
          ...
          <section className="border-y border-[var(--line)] bg-[var(--bg)] text-[var(--fg)]">
            <div className="mx-auto max-w-[88rem] px-5 py-20 sm:px-8 sm:py-24 lg:px-12 lg:py-32">
              <Reveal>
                ...
                <p className="font-mono text-xs tracking-[0.14em] opacity-60">NEXT / CASE 01</p>
                <div>
