...
const project = {
  ...
  shortTitle: "Bengkel Mas Das",
  category: "Company Profile & Management System",
  role: "Full-Stack Developer",
  period: "Desember 2025 — Juli 2026",
  platform: "Web Application",
  focus: "Company Profile, Clustering & Decision Support",
  description:
    "Platform web terintegrasi yang berfungsi ganda sebagai Company Profile interaktif untuk memperkenalkan profil dan katalog layanan Bengkel Mas Das Balai Karya kepada publik, sekaligus sistem informasi manajemen BackEnd yang dilengkapi helpdesk konsultasi, segmentasi pelanggan (K-Means), dan pendukung keputusan strategi pemasaran (AHP).",
  technologies: ["Laravel", "MySQL", "Tailwind CSS", "Vanilla JavaScript", "K-Means", "AHP"],
  screenshots: [
    {
      src: "/images/projects/workshop/0906.mp4",
      mediaType: "video",
      alt: "Demo singkat platform Bengkel Mas Das",
      caption: "Demo singkat halaman utama",
    },
    {
      src: "/images/projects/workshop/konsul.png",
      alt: "Halaman konsultasi pelanggan dengan unggah foto keluhan",
      caption: "Pelanggan dapat menyampaikan keluhan melalui konsultasi online serta melampirkan foto kondisi kendaraan.",
    },
    {
      src: "/images/projects/workshop/dasmin.png",
      alt: "Dashboard admin sistem bengkel",
      caption: "Dashboard admin merangkum aktivitas pelanggan, layanan, pesan masuk, dan indikator operasional dalam satu tampilan.",
    },
    {
      src: "/images/projects/workshop/kllpelanggan.png",
      alt: "Halaman kelola pelanggan",
      caption: "Admin mengelola data pelanggan dan riwayat interaksi sebagai dasar pelayanan yang lebih terarah.",
    },
    {
      src: "/images/projects/workshop/kllkues.png",
      alt: "Halaman data kuesioner",
      caption: "tampilan data kuesioner yang diperoleh",
    },
    {
      src: "/images/projects/workshop/klltiket.png",
      alt: "Halaman kelola pesan masuk",
      caption: "Pesan konsultasi tersusun di inbox sehingga admin dapat menindaklanjuti keluhan secara terukur.",
    },
    {
      src: "/images/projects/workshop/kllproduk.png",
      alt: "Halaman kelola produk dan layanan",
      caption: "Admin memperbarui katalog produk atau layanan lengkap dengan informasi yang dibutuhkan pelanggan.",
    },
    {
      src: "/images/projects/workshop/kmeans.png",
      alt: "Hasil analisis segmentasi pelanggan dengan K-Means",
      caption: "Analisis K-Means mengelompokkan pelanggan berdasarkan pola transaksi dan karakteristik servis.",
    },
    {
      src: "/images/projects/workshop/ahp.png",
      alt: "Hasil analisis prioritas strategi dengan AHP",
      caption: "Analisis AHP membantu menentukan prioritas strategi berdasarkan bobot dan konsistensi kriteria.",
    },
  ] as Screenshot[],
  githubUrl: "https://github.com/muhfatkhur/Compro-AHP-KMeans" as string | null,
  liveUrl: null as string | null,
};

const workflow = [
  {
    title: "Public Showcase (Compro)",
    description: "Pengunjung dapat melihat profil bisnis, galeri bengkel, serta daftar katalog layanan servis yang tersedia.",
  },
  {
    title: "Customer Engagement (Helpdesk)",
    description: "Pelanggan mengirimkan tiket keluhan mesin beserta foto keluhan sebelum memutuskan datang ke lokasi.",
  },
  {
    title: "Data Collection",
    description: "Seluruh data transaksi, kuesioner perilaku, dan riwayat servis dihimpun ke dalam basis data relasional.",
  },
  {
    title: "Customer Segmentation (K-Means)",
    description: "Algoritma K-Means memproses data untuk mengelompokkan pelanggan berdasarkan kesamaan pola servis.",
  },
  {
    title: "Decision Support (AHP)",
    description: "Pengelola mengevaluasi matriks perbandingan berpasangan untuk memproses bobot kriteria strategi pemasaran.",
  },
  {
    title: "Strategic Dashboard",
    description: "Dasbor admin menyajikan laporan ringkas hasil segmentasi pelanggan dan peringkat keputusan strategis secara visual.",
  },
];
...
const features: Feature[] = [
  {
    ...
    description: "Etalase digital publik yang memuat informasi profil usaha, jam operasional, galeri, dan keunggulan bengkel.",
    icon: Search,
  },
  {
    title: "Katalog Layanan & Produk",
    description: "Manajemen data servis perbaikan, suku cadang, dan informasi harga yang transparan bagi kustomer.",
    icon: Wrench,
  },
  {
    title: "Helpdesk Konsultasi Interaktif",
    description: "Modul tiket dua arah bagi pelanggan untuk berkonsultasi keluhan mesin dengan melampirkan foto secara langsung.",
    icon: ListChecks,
  },
  {
    title: "K-Means Clustering Engine",
    description: "Pemrosesan otomatis untuk mengelompokkan tingkat loyalitas dan perilaku pelanggan.",
    icon: Layers3,
  },
  {
    title: "AHP Decision Engine",
    description: "Kalkulasi untuk perankingan strategi pemasaran bengkel.",
    icon: Calculator,
  },
  {
    title: "Interactive Admin Dashboard",
    description: "Antarmuka pengelola responsif untuk memantau metrik bisnis, status tiket, dan hasil analitik data.",
    icon: BarChart3,
  },
];
...
function ProjectImage({
    ...
    return (
      <div className="absolute inset-0 grid place-items-center bg-[var(--surface)] p-6 text-center">
        <div>
          ...
          <p className="mt-4 text-sm font-semibold text-[var(--fg)]">Media belum tersedia</p>
  ...
  if (isVideoSource(screenshot)) {
    return (
      <video
        src={screenshot.src}
        poster={screenshot.poster}
        aria-label={screenshot.alt}
        className="absolute inset-0 size-full bg-black object-contain p-0 transition-transform duration-500 group-hover:scale-[1.02]"
    ...
    <>
      ...
      >
          ...
          {screenshots.map((screenshot, index) => (
            ...
            >
              <button
                ...
                aria-label={`Open media ${index + 1} of ${screenshots.length} in fullscreen`}
              >
        ...
        <p className="sr-only" aria-live="polite" aria-atomic="true">
          Media {current + 1} dari {screenshots.length}: {screenshots[current].alt}
        </p>
      </div>
        ...
        >
          {screenshots.map((screenshot, index) => (
            <button
              ...
              aria-label={`Go to media ${index + 1} of ${screenshots.length}`}
          ...
          <div className="relative flex min-h-0 flex-col">
            ...
            <figure className="flex min-h-0 flex-1 flex-col items-center justify-center">
              <div className="relative min-h-0 w-full flex-1">
                <ProjectImage screenshot={screenshots[current]} priority showControls />
              </div>
    ...
    <div className="route-transition" role="status" aria-live="polite">
      ...
      <div className="route-transition-shell">
        <div className="route-transition-topline">
          ...
          <span className="route-transition-code">SYS://CASE-02</span>
        </div>
...
export default function WorkshopRecommendationPage() {
  ...
  return (
    <>
      ...
      <meta
        name="description"
        content="Case study sistem manajemen dan pendukung keputusan Bengkel Mas Das menggunakan K-Means dan AHP."
      />
                ...
                <div className="grid gap-10 lg:grid-cols-[minmax(0,1.25fr)_minmax(18rem,0.75fr)] lg:gap-16">
                  <div className="max-w-3xl space-y-6 text-lg leading-8 tracking-[-0.01em] sm:text-xl sm:leading-9">
                    ...
                    <p className="text-[var(--muted)]">
                      Sistem menghubungkan etalase publik, helpdesk pelanggan,
                      pengelolaan data bengkel, K-Means, dan AHP dalam satu
                      aplikasi web.
                    </p>
                  </div>
                  ...
                  <dl className="border-t border-[var(--line)]">
                    {[
                      ...
                      ["PRIMARY USER", "Administrator bengkel & pelanggan"],
                      ["ANALYTICS", "K-Means & AHP"],
                      ["PLATFORM", project.platform],
              ...
              <Reveal>
                ...
                <div>
                  ...
                  <h2 className="mt-5 max-w-5xl text-balance text-4xl font-medium leading-[1.04] tracking-[-0.055em] sm:text-6xl lg:text-7xl">
                    Point of Sales dengan Forecasting
                  </h2>
