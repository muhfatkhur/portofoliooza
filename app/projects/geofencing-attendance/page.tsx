...
const project = {
  number: "01",
  slug: "geofencing",
  title: "Sistem  Presensi Berbasis Geofencing dan Notifikasi WhatsApp API",
  shortTitle: "Smart Geo-Attendance & WA Notif",
  category: "Full-Stack Web Development (Laravel)",
  role: "Full-Stack Developer",
  platform: "Web Application",
  focus: "Geofencing, Live Camera & WhatsApp Automation",
  description:
    "Aplikasi absensi digital yang memadukan pelacakan koordinat radius (GPS) dan validasi swafoto secara real time untuk mencegah manipulasi kehadiran, dan notifikasi WhatsApp otomatis.",
  technologies: ["Laravel", "Leaflet.js", "Geolocation API", "Fonnte API", "MySQL", "Queue"],
  screenshots: [
    {
      src: "/images/projects/geofencing/01.png",
      alt: "Dasbor admin rekap kehadiran",
      caption: "Dasbor admin untuk memantau dan mengekspor data kehadiran.",
    },
    {
      src: "/images/projects/geofencing/lokasi.png",
      alt: "Peta geofencing untuk validasi lokasi presensi",
      caption: "Pemetaan titik sekolah dan radius presensi menggunakan Leaflet.js.",
    },
    {
      src: "/images/projects/geofencing/log.png",
      alt: "Mengirim Notifikasi WhatsApp setelah presensi",
      caption: "Notifikasi kehadiran dikirim melalui Fonnte WhatsApp API.",
    },
    {
      src: "/images/projects/geofencing/datasiswa.png",
      alt: "kelola data siswa",
      caption: "mengelola data siswa, mutasi kelas, dan kenaikan kelas otomatis melalui import Excel.",
    },
    {
      src: "/images/projects/geofencing/laporanpresen.png",
      alt: "laporan presensi siswa dan guru",
      caption: "Laporan presensi siswa dan guru berdasarkan hari, dan dapat diekspor ke Excel.",
    },
    {
      src: "/images/projects/geofencing/absenn.png",
      alt: "Halaman presensi siswa dan guru",
      caption: "halaman presensi dengan status lokasi, waktu, dan hasil validasi kamera.",
    },
  ] as Screenshot[],
...
const workflow = [
  {
    title: "Pendeteksian & Pemetaan Lokasi",
    description: "Pengguna mengakses web presensi, lalu sistem menggunakan Leaflet.js untuk mendeteksi koordinat perangkat serta memetakannya secara visual.",
  },
  {
    title: "Validasi Geofencing (Radius)",
    description: "Sistem mengkalkulasi jarak aktual pengguna dengan titik pusat sekolah. Tombol presensi hanya aktif ketika pengguna berada di dalam radius yang diizinkan.",
  },
  {
    title: "Live Capture & Sinkronisasi",
    description: "Pengguna mengambil swafoto langsung dari kamera. Waktu, koordinat, foto, dan status kehadiran dikirim serta disimpan ke backend.",
  },
  {
    title: "Notifikasi WhatsApp Otomatis",
    description: "Setelah presensi berhasil, Fonnte API  mengirim notifikasi WhatsApp tanpa mengganggu loading halaman.",
  },
  {
    title: "Otomatisasi & Rekapitulasi Admin",
    description: "Admin memantau kehadiran, mengekspor laporan berdasarkan peran Guru atau Siswa, serta mengelola tahun ajaran dan mutasi kelas.",
  },
];

const features: Feature[] = [
  {
    title: "Geofencing & Map Integration",
    description: "Validasi radius absensi menggunakan Leaflet.js untuk mengunci zona kehadiran berdasarkan titik lokasi sekolah.",
    icon: MapPin,
  },
  {
    title: "Live Camera Validation",
    description: "Akses kamera web atau HP secara real time untuk mencegah penggunaan foto palsu saat melakukan presensi.",
    icon: Camera,
  },
  {
    title: "WhatsApp API Gateway (Fonnte)",
    description: "Pengiriman notifikasi kehadiran otomatis kepada orang tua atau wali melalui integrasi Fonnte WhatsApp API.",
    icon: MessageCircle,
  },
  {
    title: "Auto Promote",
    description: "Otomatisasi kenaikan kelas berjenjang, kelulusan massal, dan mutasi kelas dengan satu aksi di sisi admin.",
    icon: RefreshCw,
  },
];
...
export default function WorkshopRecommendationPage() {
  ...
  return (
    <>
      ...
      <meta
        name="description"
        content="Case study sistem presensi cerdas berbasis geofencing, verifikasi kamera, dan notifikasi WhatsApp API."
      />
                ...
                <div className="grid gap-10 lg:grid-cols-[minmax(0,1.25fr)_minmax(18rem,0.75fr)] lg:gap-16">
                  <div className="max-w-3xl space-y-6 text-lg leading-8 tracking-[-0.01em] sm:text-xl sm:leading-9">
                    ...
                    <p className="text-[var(--muted)]">
                      Aplikasi presensi digital berbasis web (Laravel) yang
                      dirancang untuk memastikan kedisiplinan dan validitas
                      kehadiran. Sistem memadukan teknologi pemetaan spasial
                      (Leaflet.js) untuk memvalidasi posisi presensi di dalam
                      batas radius sekolah, serta mewajibkan tangkapan foto
                      langsung dari kamera. Integrasi Fonnte WhatsApp API,
                      validasi import Excel anti duplikat, dan algoritma mutasi kelas otomatis.
                    </p>
                  </div>
                  ...
                  <dl className="border-t border-[var(--line)]">
                    {[
                      ...
                      ["PRIMARY USER", "Guru, siswa, wali & admin"],
                      ["LOCATION ENGINE", "Leaflet.js + Geofencing"],
          ...
          <section className="border-y border-[var(--line)] bg-[var(--bg)] text-[var(--fg)]">
            <div className="mx-auto max-w-[88rem] px-5 py-20 sm:px-8 sm:py-24 lg:px-12 lg:py-32">
              <Reveal>
                ...
                <p className="font-mono text-xs tracking-[0.14em] opacity-60">NEXT / CASE 02</p>
                <div>
                  ...
                  <h2 className="mt-5 max-w-5xl text-balance text-4xl font-medium leading-[1.04] tracking-[-0.055em] sm:text-6xl lg:text-7xl">
                    Sistem Informasi Manajemen, Compro & SPK Bengkel
                  </h2>
                  <div className="mt-10 flex flex-wrap gap-3">
                    <Link
                      href="/projects/workshop-recommendation"
                      onClick={(event) => handleNavigation(event, "/projects/workshop-recommendation", "NEXT CASE STUDY")}
